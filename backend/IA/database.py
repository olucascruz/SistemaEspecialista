...
mineral_water_potability_cases = open_csv(path.join(path_dir,r"waterQuality.csv"))
...
df_norm_global.to_csv(path.join(path_dir,r"waterQualityNormalized.csv"), index=False)

# Saving the metrics information (mean, std, weights) to a JSON file
metrics_json_path = path.join(path_dir,r'metrics.json')
